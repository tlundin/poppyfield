...
/*
    ...
    public static String analyze(List<EvalExpr> expressions, Map<String,String> evalContext) {
        ...
        if (expressions == null) {
            o.d("EXPR","");
            o.e("Expression was null in Analyze. This is likely due to a syntax error in the original formula");
            return null;
        }
    ...
    public static Boolean analyzeBooleanExpression(EvalExpr expr, Map<String,String> evalContext, List<List<String>> targetList) {
        ...
        //o.d("EXPR","Expression "+expr.toString()+" evaluated to "+eval);
        variables = null;
...
//                        Log.d("vortex","evalArgs.get0 is "+evalArgs.get(0)+" type "+evalArgs.get(0).getClass().getSimpleName());
                ...
                case historical:
                    ...
                    if (checkPreconditions(evalArgs,1,No_Null_Literal)) {
                        ...
                        if (var != null) {
                            ...
                            o.d("EXPR","");
                            o.e("Variable not found in historical: ["+evalArgs.get(0)+"]");
                        }
                    } else
                            ...
                            for (String name:vars.keySet()) {
                                ...
                                if (value!=null) {
                                    ...
                                    if (historicalValue==null) {
                                        ...
                                        o.d("EXPR","hasSameValueAsHistorical returns false, since variable "+name+" has a value: "+value+" but no historical value.");
                                        return false;
                                    } else {
                                        if (!historicalValue.equals(value)) {
                                            ...
                                            o.d("EXPR","hasSameValueAsHistorical returns false, since variable "+name+" has a value: "+value+" that is not the same as the historical value: "+historicalValue);
                ...
                case getStatusVariableValues:
                    ...
                    if (checkPreconditions(evalArgs,1,No_Null_Literal)) {
                        ...
                        if (cp==null || empty) {
                            o.d("EXPR","");
                            o.e("getStatusVariableValues finds no match with argument "+ evalArgs.get(0));
                ...
                case getDelytaArea:
                    if (checkPreconditions(evalArgs,1,No_Null)) {
                        ...
                        if (dym == null) {
                            o.d("EXPR","");
                            o.e("Cannot calculate delyta area...no provyta selected");
                            return null;
                        }
                        ...
                        if (area == 0) {
                            ...
                            o.d("EXPR","Area 0");
                            o.e("Either Delyta "+evalArgs.get(0)+" does not exist or area is 0 (in function getDelytaArea)");
                            return null;
                        }
                        ...
                        for (List<String> row : rows) {
                            ...
                            if (getType() == TokenType.hasValue ||
                                ...
                                for (int i = 1; i < evalArgs.size(); i++) {
                                    ...
                                    if (size < 3) {
                                        o.d("EXPR","");
                                        o.e("This variable has no Functional Group...cannot apply hasSame function. Variable id: " + Arrays.toString(varNameA));
                            ...
                            for (String key : values.keySet()) {
                                ...
                                for (int i = 1; i < evalArgs.size() - 1; i++) {
                                    ...
                                    if (vCompare == null && vz == null || vCompare != null && vz != null)
                                        ...
                                        o.d("EXPR","hasSame difference detected for " + key + ". Stopping");
                ...
                case has:
                    ...
                    if (var != null) {
                        ...
                        Log.e("vortex","Variable not found for literal: ["+evalArgs.get(0)+"]");
                        o.d("EXPR","");
                        o.e("Variable not found in Has(): ["+evalArgs.get(0)+"]");
                        return null;
                    }
                    //return checkPreconditions(evalArgs,1,No_Null);
                ...
                case hasAll:
                    if (checkPreconditions(evalArgs,1,No_Null_Literal)) {
                        ...
                        if (rows == null || rows.size() == 0) {
                            o.d("EXPR","");
                            o.e("Filter returned empty list in HASx construction. Filter: " + getType());
                            o.d("EXPR","");
                            o.e("Check your pattern: " + evalArgs.get(0));
                            return null;
                        }
    ...
    private String getValue(String varId) {
        ...
        return model.latestMatch(varId);
    }
    ...
    private static void printfail(Expr rez, Expr arg2, Expr op) throws ExprEvaluationException {
        if (o!=null) {
            o.d("EXPR","");
            o.e("Missing or wrong parameters. This is likely caused by a misplaced paranthesis.");
            o.e("arg1: "+rez);
            o.e("arg2: "+arg2);
            o.e("operator: "+op);
        }
